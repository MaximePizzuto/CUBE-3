...
router.post('/Facture/add_Facture', (req, res) => {
  ...
  const Facture = new Facture({ Id, Id_Facture, Id_user, Montant_HT, Montant_TTC, Formule, Date_payement, Id_Abonnement, Description, Date_Creation, Date_Modification, pdf_facture, csv_facture });
